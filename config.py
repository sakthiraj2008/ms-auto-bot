...
# Name of the (public) Supabase Storage bucket that /add_content uploads
# posters and banners into. Create this bucket in your Supabase dashboard
# (Storage -> New bucket -> mark it Public) before using /add_content, or
# set this to the name of a bucket you already have.
SUPABASE_STORAGE_BUCKET = environ.get("SUPABASE_STORAGE_BUCKET", "content-images")
